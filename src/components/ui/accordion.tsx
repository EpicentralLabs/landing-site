...
>(({ className, ...props }, ref) => (
  <AccordionPrimitive.Item
    ref={ref}
    className={cn(
      "border-b transition-all duration-300 hover:bg-white/5 rounded-lg", 
      "hover:drop-shadow-[0_0_15px_rgba(255,255,255,0.07)]",
      className
    )}
    {...props}
  />
  ...
  <AccordionPrimitive.Header className="flex">
    <AccordionPrimitive.Trigger
      ...
      className={cn(
        ...
        "[&[data-state=open]>div>div:first-child>svg]:rotate-180",
        "rounded-lg px-4",
        className
      )}
      {...props}
